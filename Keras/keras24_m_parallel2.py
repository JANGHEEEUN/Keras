...
model = Sequential()
model.add(LSTM(10, activation = 'relu', input_shape=(3,3))) # input_shape(열, 몇 개씩 자르는지) #(3,1): 열이 3개고 데이터 셋을 1개씩 잘라서 작업
...
x_prd = np.array([[90,95,105],[100,105,205],[110,115,225]])
print(x_prd.shape)
