...
df1 = pd.read_csv('./Keras/Downloads/samsung.csv', index_col=0,
                  header = 0, encoding='cp949', sep=',')
print(df1.info)
# print(df1.shape)

df2 = pd.read_excel('./Keras/Downloads/삼성전자 0203-0206.xlsx', index_col=0,
                  header = 0, encoding='cp949', sep=',')
...
np.save('./Keras/Downloads/samsung2.npy', arr=samsung)