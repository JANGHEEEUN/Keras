...
model.fit([x1_train, x2_train], [y1_train, y2_train, y3_train],epochs=200, batch_size=10, validation_data=([x1_val, x2_val], [y1_val, y2_val, y3_val]), callbacks=[early_stopping, tb_hist]) 
